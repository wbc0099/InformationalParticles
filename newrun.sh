...
#echo $kBTChangePM
visionConeXLen=$(python3 -c "import math; print('{:.2f}'.format(math.cos(math.radians($theta))))")
...
# dirName="eccentricCircleX4"
# dirName="eccentricRectangle41Y4"
# dirName="cross41"
